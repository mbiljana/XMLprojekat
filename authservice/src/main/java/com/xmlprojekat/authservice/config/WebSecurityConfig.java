package com.xmlprojekat.authservice.config;
...
import com.xmlprojekat.authservice.security.RestAuthenticationEntryPoint;
import com.xmlprojekat.authservice.security.TokenAuthenticationFilter;
import com.xmlprojekat.authservice.service.impl.CustomUserDetailsService;
import com.xmlprojekat.authservice.util.TokenUtils;
@Configuration
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
								.antMatchers("/h2/**").permitAll()	// /h2-console/** ako se koristi H2 baza)
