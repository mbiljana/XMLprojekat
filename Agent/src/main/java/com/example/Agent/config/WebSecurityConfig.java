...
import com.example.Agent.security.RestAuthenticationEntryPoint;
import com.example.Agent.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("api/company/update").permitAll()
