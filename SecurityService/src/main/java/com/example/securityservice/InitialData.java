...
public class InitialData {
    ...
    public void init(){
        ...
        User u3 = new User((long)3,"maja", "$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra","Marko","Markovic", "markom@gmail.com",true,role1,"User");
        ...
        //company
        User c1 = new User((long)12, "m&i","$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", "M&I", "Co","m&i@gmail.com",true, role3,"Company");
        userService.saveUser(u1);
        userService.saveUser(u2);
        userService.saveUser(u3);
        userService.saveUser(u4);
        userService.saveUser(c1);
